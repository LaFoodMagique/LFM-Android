...
public class HomeFragment extends BasicFragment {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new BlankFragment(), getString(R.string.tab_home_string_first));
        adapter.addFrag(new BlankFragment(), getString(R.string.tab_home_string_second));
        adapter.addFrag(new BlankFragment(), getString(R.string.tab_home_string_third));
